...
async function main() {
  ...
  const plateStoreData = [
    ...
    },
    {
      ...
      numberOfColours: 4,
      colours: [
        { name: 'C', type: 'process', status: 'issued', rackLocation: 'On Press PRN-01', slotNumber: null, condition: 'Good' },
        { name: 'M', type: 'process', status: 'issued', rackLocation: 'On Press PRN-01', slotNumber: null, condition: 'Good' },
        { name: 'Y', type: 'process', status: 'issued', rackLocation: 'On Press PRN-01', slotNumber: null, condition: 'Good' },
        { name: 'K', type: 'process', status: 'issued', rackLocation: 'On Press PRN-01', slotNumber: null, condition: 'Good' },
      ],
      totalPlates: 4,
      newPlatesCount: 0,
      oldPlatesCount: 4,
