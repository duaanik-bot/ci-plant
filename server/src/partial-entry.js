// How an operator types a partial count. Pure arithmetic, no DB and no React —
// same shape as stage-runs.js / board-math.js so both twins stay unit-testable.
//
// A stage is filled over several entries ("20,000 today, 10,000 tomorrow,
// 1 to finish the bundle"). There are two honest ways to type the second one:
//
