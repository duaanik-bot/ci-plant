...
export default function InventoryPurchaseRequisitionsMovedPage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-8 text-ds-ink">
      <section className="rounded-ds-lg border border-ds-line/40 bg-background p-6 shadow-ds-depth-sm">
        ...
        <h1 className="mt-2 text-xl font-semibold text-[var(--brand-primary)]">Purchase requisitions moved</h1>
