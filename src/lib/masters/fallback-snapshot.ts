...
export const FALLBACK_REGISTRY: RegistryPayload = {
  ...
  BOARD_TYPE: {
    ...
    values: [
      ...
      { code: 'SAFF', label: 'Saffire', abbreviation: null, sortOrder: 20 },
  ...
  BOARD_COLOUR: {
    code: 'BOARD_COLOUR', label: 'Board Variant',
    values: [
      { code: 'FBB', label: 'FBB', abbreviation: null, sortOrder: 10 },
      { code: 'SAFF', label: 'Saffire', abbreviation: null, sortOrder: 20 },
      { code: 'DGB', label: 'GB', abbreviation: null, sortOrder: 30 },
      { code: 'DWB', label: 'WB', abbreviation: null, sortOrder: 40 },
    ],
  },
