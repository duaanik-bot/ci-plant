...
export const dataTable = {
  ...
  filter: {
    input:
      'w-full min-w-0 border-0 border-b border-ds-line/80 bg-transparent py-1.5 text-sm text-ds-ink placeholder:text-ds-ink-faint focus:border-b-2 focus:border-ds-brand focus:outline-none focus:ring-0',
  },
  tr: {
