          ...
          >
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                ...
                <div className="mt-1.5">
                  <span
                    className={`inline-block rounded-ds-sm px-2 py-0.5 text-xs font-bold ring-1 ${labelClass[b.label]}`}
                  >
                    {b.label}
                  </span>
                </div>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex flex-1 items-center justify-center gap-1 rounded-ds-md bg-[var(--success-bg)]/90 px-3 py-2 text-xs font-semibold text-white hover:bg-[var(--success-bg)]"
              >
