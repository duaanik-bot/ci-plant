...
export function HubPriorityReorderAuditFooter({
  ...
  return (
    <div
      className={`pt-1.5 mt-1.5 flex items-center gap-1.5 min-w-0 font-designing-queue text-xs leading-tight text-ds-ink-muted dark:text-ds-ink-faint ${className}`.trim()}
