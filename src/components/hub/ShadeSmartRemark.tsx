...
export function ShadeSmartRemark({
  ...
  return (
    <div className="group relative max-w-[7rem] font-sans">
      ...
      <div
        className="pointer-events-none invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-opacity absolute z-[80] bottom-full left-0 mb-1 w-72 rounded-lg bg-ds-main p-2 text-xs shadow-xl text-ds-ink"
        role="tooltip"
      >
