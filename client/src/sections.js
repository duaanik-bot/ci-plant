...
export const SECTION_META = {
  cutting: { label: 'Cutting', icon: Scissors, tint: 'text-slate-600 bg-slate-100' },
  ...
  lamination: { label: 'Lamination', icon: Layers, tint: 'text-teal-600 bg-teal-50' },
  ...
  die_cutting: { label: 'Die Cutting', icon: Square, tint: 'text-rose-600 bg-rose-50' },
  sorting: { label: 'Sorting', icon: ListChecks, tint: 'text-fuchsia-600 bg-fuchsia-50' },
