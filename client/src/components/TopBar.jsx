        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          ...
          <div className="relative shrink-0" ref={menuRef}>
            ...
            {menuOpen && createPortal(
              <div data-ci-overlay ref={menuPopRef} role="menu" className="glass fixed right-3 top-[var(--ci-menu-top)] z-[60] w-[232px] origin-top-right animate-liquidPop overflow-hidden rounded-2xl py-1 shadow-modal sm:right-4 lg:right-5">
